  ...
  return (
    <footer className="bg-black text-white py-12 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              Buy, sell, and succeed effortlessly with EX — featuring secure transactions, fast processing, and
          ...
          {/* Newsletter and Get In Touch */}
          <div className="space-y-8">
            {/* Newsletter */}
            <div>
              <h3 className="font-medium text-lg mb-4">Newsletter</h3>
              <p className="text-sm text-gray-300 mb-4">Stay always in touch! Subscribe to our newsletter</p>
              <div className="flex space-x-2">
                <Input type="email" placeholder="Email Address" className="bg-zinc-900 border-zinc-800 text-white" />
                <Button className="bg-[#c1ff00] hover:bg-[#a8e600] text-black">Subscribe</Button>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mb-4">Stay up to Date with EX - market insights & more</p>
              <div className="flex space-x-4">
                <Link href="#" className="text-white hover:text-[#c1ff00]">
        ...
        {/* Copyright */}
        <div className="mt-16 text-center text-sm text-gray-500">2025 Company Exchange™</div>
      </div>
    </footer>
  )
}
