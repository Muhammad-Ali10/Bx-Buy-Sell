...
const AddManagementQuestion = ({ mode = "create", id, question, answer_type }) => {
    const { mutate: uploadManagement } = useUploadAdminQuestion()
    const { mutate: updateManagement } = useUpdateAdminQuestion()
    ...
    function handleSubmit(data) {
        ...
        if (mode === "create") {
            uploadManagement(managementData, {
                onSuccess: () => {
                    toast.success("Management Qusetion created successfully")
                    form.reset()
                },
                onError: (err) => {
                    toast.error(
            ...
            updateManagement(
                ...
                {
                    onSuccess: () => {
                        toast.success("Management Qusetion updated successfully")
                    },
                    onError: (err) => {
                        toast.error(
...
export default AddManagementQuestion
