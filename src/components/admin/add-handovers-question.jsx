...
const AddHandOverQuestion = ({ mode = "create", id, question, answer_type }) => {
    const { mutate: uploadHANDOVER } = useUploadAdminQuestion()
    const { mutate: updateHANDOVER } = useUpdateAdminQuestion()
    ...
    function handleSubmit(data) {
        ...
        if (mode === "create") {
            uploadHANDOVER(adsData, {
                onSuccess: () => {
                    toast.success("HandOver Qusetion created successfully")
                    form.reset()
                },
                onError: (err) => {
                    toast.error(
            ...
            updateHANDOVER(
                ...
                {
                    onSuccess: () => {
                        toast.success("HandOver Qusetion updated successfully")
                    },
                    onError: (err) => {
                        toast.error(
