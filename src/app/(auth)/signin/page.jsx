  ...
  return (
    <div className="flex flex-col  md:flex-row w-full  md:max-w-1920 h-full min-h-screen  mx-auto">
      ...
      <div className="flex justify-center items-center  w-full mx-auto flex-col gap-4">
        <div className="w-full flex flex-col items-center justify-center p-6 md:p-5 lg:p-10">
          {/* Left Section - Sign Up Form */}
          <div className="w-full max-w-[430px]">
            ...
            {/* Heading */}
            <h1 className="text-3xl font-semibold font-sora text-center mb-2">Login Account</h1>
            ...
            <Form {...form}>
              <form className="space-y-4" onSubmit={form.handleSubmit(handleSubmit)}>
                ...
                />
                {/*  Button */}
                <Button type="submit" className="w-full py-5 bg-[#C5FD1F] text-black text-base font-medium font-lufga rounded-full">
                  Login
                </Button>
              </form>
            </Form>
