...
import AddProductQuestion from "@/components/admin/add-product-question"
import { useGetAdminQuestion, useDeleteAdminQuestion } from "@/hooks/adminQuestions"

const Product = () => {
    const { data, isPending, error } = useGetAdminQuestion("PRODUCT")
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className="p-0 border-0 rounded-2xl shadow-2xl w-full flex flex-col !max-w-[720px] h-full">
                                            ...
                                            <div className="px-6 pb-6 h-full">
                                                <AddProductQuestion mode="edit" question={item.question} id={item.id} />
                                            </div>
                                        </DialogContent>
                                    </Dialog>
