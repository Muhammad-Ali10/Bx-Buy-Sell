...
import AdsQuestion from "@/components/admin/ad-info-question"
import { useGetAdminQuestion, useDeleteAdminQuestion } from "@/hooks/adminQuestions"

const AddInformation = () => {
    const { data, isPending, error } = useGetAdminQuestion("ADVERTISMENT")
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className="p-0 border-0 rounded-2xl shadow-2xl w-full flex flex-col !max-w-[720px] h-full">
                                            ...
                                            <div className="px-6 pb-6 h-full">
                                                <AdsQuestion mode="edit" question={item.question} id={item.id} />
                                            </div>
                                        </DialogContent>
                                    </Dialog>
