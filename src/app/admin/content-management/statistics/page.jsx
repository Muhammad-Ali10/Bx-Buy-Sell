...
import AddStatisticQuestion from "@/components/admin/add-statistics-question"
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className="p-0 border-0 rounded-2xl shadow-2xl w-full flex flex-col !max-w-[720px] h-full">
                                            ...
                                            <div className="px-6 pb-6 h-full">
                                                <AddStatisticQuestion mode="edit" question={item.question} id={item.id} />
                                            </div>
                                        </DialogContent>
                                    </Dialog>
